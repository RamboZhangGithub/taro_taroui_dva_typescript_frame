...
var AtButton = /** @class */ (function (_super) {
    ...
    AtButton.prototype.render = function () {
        ...
        return (React__default.createElement(components.View, { className: classnames(rootClassName, classObject, this.props.className), style: customStyle, onClick: this.onClick.bind(this) },
            ...
            isWEAPP && !disabled && (React__default.createElement(components.Form, { onSubmit: this.onSumit.bind(this), onReset: this.onReset.bind(this) }, button)),
    ...
    AtInput.prototype.render = function () {
        ...
        return (React__default.createElement(components.View, { className: rootCls, style: customStyle },
            React__default.createElement(components.View, { className: containerCls },
                React__default.createElement(components.View, { className: overlayCls, onClick: this.handleClick }),
                title && (React__default.createElement(components.Label, { className: "at-input__title " + (required && 'at-input__title--required'), for: name }, title)),
                ...
                clear && value && (React__default.createElement(components.View, { className: 'at-input__icon', onTouchEnd: this.handleClearValue },
                    React__default.createElement(components.Text, { className: 'at-icon at-icon-close-circle at-input__icon-close' }))),
                error && (React__default.createElement(components.View, { className: 'at-input__icon', onTouchStart: this.handleErrorClick },
...
var AtNoticebar = /** @class */ (function (_super) {
    ...
    AtNoticebar.prototype.render = function () {
        ...
        return (show && (React__default.createElement(components.View, { className: classnames(rootClassName, classObject, className), style: customStyle },
            ...
            React__default.createElement(components.View, { className: 'at-noticebar__content' },
                ...
                React__default.createElement(components.View, { className: 'at-noticebar__content-text' },
                    React__default.createElement(components.View, { id: animElemId, animation: animationData, className: classnames(innerClassName), style: style }, this.props.children))),
            showMore && (React__default.createElement(components.View, { className: 'at-noticebar__more', onClick: this.onGotoMore.bind(this) },
                React__default.createElement(components.Text, { className: 'text' }, moreText),
...
var AtSwipeActionOptions = /** @class */ (function (_super) {
    ...
    AtSwipeActionOptions.prototype.render = function () {
        ...
        return (React__default.createElement(components.View, { id: "swipeActionOptions-" + this.props.componentId, className: rootClass, style: this.props.customStyle }, this.props.children));
    };
...
var AtSwipeAction = /** @class */ (function (_super) {
    ...
    AtSwipeAction.prototype.render = function () {
        ...
        return (React__default.createElement(components.View, { id: "swipeAction-" + componentId, className: rootClass, style: {
                width: this.eleWidth + "px"
            } },
            React__default.createElement(components.MovableArea, { className: 'at-swipe-action__area', style: {
                    width: this.eleWidth + this.maxOffsetSize + "px",
                    transform: "translate(-" + this.maxOffsetSize + "px, 0)"
                } },
                React__default.createElement(components.MovableView, { className: 'at-swipe-action__content', direction: 'horizontal', damping: 50, x: offsetSize, onTouchEnd: this.onTouchEnd, onChange: this.onChange, style: {
                        width: this.eleWidth + "px",
                        left: this.maxOffsetSize + "px"
                    } },
                    this.props.children,
                    Array.isArray(options) && options.length > 0 ? (React__default.createElement(AtSwipeActionOptions, { options: options, componentId: componentId, customStyle: {
                            transform: "translate(" + this.maxOffsetSize + "px, 0)",
                            opacity: 1
                        } }, options.map(function (item, key) { return (React__default.createElement(components.View, { key: item.text + "-" + key, style: item.style, onClick: function (e) { return _this.handleClick(item, key, e); }, className: classnames('at-swipe-action__option', item.className) },
        ...
        return (React__default.createElement(components.View, { className: rootCls, style: customStyle }, matrix.map(function (row, i) { return (React__default.createElement(components.View, { className: 'at-image-picker__flex-box', key: i + 1 }, row.map(function (item, j) {
            return item.url ? (React__default.createElement(components.View, { className: 'at-image-picker__flex-item', key: i * length + j },
                React__default.createElement(components.View, { className: 'at-image-picker__item' },
                    ...
                    React__default.createElement(components.Image, { className: 'at-image-picker__preview-img', mode: mode, src: item.url, onClick: _this.handleImageClick.bind(_this, i * length + j) })))) : (React__default.createElement(components.View, { className: 'at-image-picker__flex-item', key: 'empty_' + i * length + j }, item.type === 'btn' && (React__default.createElement(components.View, { className: 'at-image-picker__item at-image-picker__choose-btn', onClick: _this.chooseFile },
...
var AtCalendarList = /** @class */ (function (_super) {
    ...
    AtCalendarList.prototype.render = function () {
        ...
        if (!list || list.length === 0)
            return null;
        return (React__default.createElement(components.View, { className: 'at-calendar__list flex' }, list.map(function (item) { return (React__default.createElement(components.View, { key: "list-item-" + item.value, onClick: _this.handleClick.bind(_this, item), onLongPress: _this.handleLongClick.bind(_this, item), className: classnames('flex__item', "flex__item--" + MAP[item.type], {
