...
const index = require('./index-2f62bdaf.js');
...
const TabbarItem = (props) => {
  const { index: index$2 = null, isSelected = false, textColor = {}, iconPath = '', badgeText = null, showRedDot = false, text } = props;
  ...
  return index$1.h("a", { key: index$2, href: 'javascript:;', class: className, onClick: onClick },
    index$1.h("span", { style: { display: 'inline-block', position: 'relative' } },
      ...
      badgeText &&
        index$1.h("span", { class: 'weui-badge taro-tabbar-badge', style: badgeStyle }, badgeText),
      showRedDot &&
        index$1.h("span", { class: 'weui-badge weui-badge_dot', style: dotStyle })),
