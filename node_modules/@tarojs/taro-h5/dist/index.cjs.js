...
function createRouter(app, config, framework) {
  ...
  var render = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(location, action) {
      var _a, _b, _c, _d, element, pageConfig, enablePullDownRefresh, shouldLoad, prev, el, _config, page;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 16:
              ...
              if (shouldLoad) {
                ...
                delete _config['path'];
                delete _config['load'];
                page = runtime.createPageConfig(enablePullDownRefresh ? (_d = runtime.CurrentReconciler.createPullDownComponent) === null || _d === void 0 ? void 0 : _d.call(runtime.CurrentReconciler, el, location.pathname, framework) : el, location.pathname + runtime.stringify(qs()), {}, _config);
...
var Behavior$1 = Taro.Behavior,
    ...
    initPxTransform = Taro.initPxTransform,
